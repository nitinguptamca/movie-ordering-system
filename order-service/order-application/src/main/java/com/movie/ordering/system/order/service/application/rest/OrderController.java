package com.movie.ordering.system.order.service.application.rest;
...
import com.movie.ordering.system.order.service.domain.ports.input.service.OrderApplicationService;
...
public class OrderController {
    ...
    public ResponseEntity<CreateOrderResponse> createOrder(@RequestBody CreateOrderCommand createOrderCommand) {
        log.info("Creating order for customer: {} at cinema: {}", createOrderCommand.getCustomerId(),
