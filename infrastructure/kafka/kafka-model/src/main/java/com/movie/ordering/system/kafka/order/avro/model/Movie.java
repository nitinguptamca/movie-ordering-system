...
public class Movie extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -684151076219022144L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Movie\",\"namespace\":\"com.movie.ordering.system.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"logicalType\":\"uuid\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public Movie(java.lang.String id, java.lang.Integer quantity) {
    this.id = id;
   ...
   */
  public static com.movie.ordering.system.kafka.order.avro.model.Movie.Builder newBuilder() {
    return new com.movie.ordering.system.kafka.order.avro.model.Movie.Builder();
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static com.movie.ordering.system.kafka.order.avro.model.Movie.Builder newBuilder(com.movie.ordering.system.kafka.order.avro.model.Movie.Builder other) {
    if (other == null) {
      return new com.movie.ordering.system.kafka.order.avro.model.Movie.Builder();
    } else {
      return new com.movie.ordering.system.kafka.order.avro.model.Movie.Builder(other);
    }
  }
   ...
   * @return A new Movie RecordBuilder
   */
  public static com.movie.ordering.system.kafka.order.avro.model.Movie.Builder newBuilder(com.movie.ordering.system.kafka.order.avro.model.Movie other) {
    if (other == null) {
      return new com.movie.ordering.system.kafka.order.avro.model.Movie.Builder();
    } else {
      return new com.movie.ordering.system.kafka.order.avro.model.Movie.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Movie>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.movie.ordering.system.kafka.order.avro.model.Movie.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.movie.ordering.system.kafka.order.avro.model.Movie other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.movie.ordering.system.kafka.order.avro.model.Movie.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.movie.ordering.system.kafka.order.avro.model.Movie.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.movie.ordering.system.kafka.order.avro.model.Movie.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.movie.ordering.system.kafka.order.avro.model.Movie.Builder clearQuantity() {
