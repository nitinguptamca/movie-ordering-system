...
public class OrderRejectedKafkaMessagePublisher implements OrderRejectedMessagePublisher {
    ...
    public OrderRejectedKafkaMessagePublisher(CinemaMessagingDataMapper cinemaMessagingDataMapper,
        ...
        try {
              CinemaApprovalResponseAvroModel cinemaApprovalResponseAvroModel  =
               cinemaMessagingDataMapper
                            .orderRejectedEventToCinemaApprovalResponseAvroModel(orderRejectedEvent);
